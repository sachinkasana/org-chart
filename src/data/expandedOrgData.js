...
export const getEmployeeTypeColors = (employeeType) => {
  const colorMap = {
    ...
    'WoodMac FTE': { bg: '#5DADE2', border: '#3498DB', text: '#fff' },
...
export const expandedOrgData = [
  // CEO Level
  generateEmployee(1, 'Elena Rodriguez', 'Chief Technology Officer', 'Executive', 'New York', null, null, 'WoodMac FTE'),

  // VP Level - Direct reports to CTO
  generateEmployee(2, 'Marcus Thompson', 'VP of Engineering', 'Engineering', 'San Francisco', 1, 1, 'WoodMac FTE'),
  generateEmployee(3, 'Priya Sharma', 'VP of Product', 'Product', 'Austin', 1, 1, 'WoodMac FTE'),
  generateEmployee(4, 'James Kim', 'VP of Data & Analytics', 'Data Science', 'Seattle', 1, 1, 'WoodMac FTE'),
  generateEmployee(5, 'Rachel Chen', 'VP of Platform & Infrastructure', 'Platform', 'Boston', 1, 1, 'WoodMac FTE'),

  // Engineering Organization - Under Marcus Thompson (VP Engineering)
  // Directors
  generateEmployee(10, 'Alex Morgan', 'Director of Engineering Initiatives', 'Engineering', 'San Francisco', 2, 2, 'WoodMac FTE'),
  generateEmployee(11, 'Sofia Martinez', 'Director of Frontend Engineering', 'Engineering', 'San Francisco', 2, 2, 'Architecture'),
  generateEmployee(12, 'David Park', 'Director of Backend Services', 'Engineering', 'Seattle', 2, 2, 'WoodMac FTE'),
  generateEmployee(13, 'Isabella Wright', 'Director of Mobile Engineering', 'Engineering', 'Austin', 2, 2, 'WoodMac FTE'),
  ...
  generateEmployee(30, 'Oliver Wilson', 'Senior Cloud Engineer', 'Engineering', 'San Francisco', 20, 11, 'WoodMac FTE'),
  ...
  generateEmployee(34, 'Nathan Anderson', 'Platform Engineer', 'Engineering', 'San Francisco', 20, 11, 'WoodMac FTE'),

  // Microservices Transformation Team
  generateEmployee(35, 'Ethan Taylor', 'Lead Software Architect', 'Engineering', 'Seattle', 21, 12, 'WoodMac FTE'),
  ...
  generateEmployee(38, 'Grace Miller', 'Technical Documentation Lead', 'Engineering', 'Remote', 21, 12, 'WoodMac FTE'),

  // DevSecOps Enhancement Team
  generateEmployee(39, 'Logan Brown', 'Security Engineer', 'Security', 'Boston', 22, 12, 'WoodMac FTE'),
  ...
  // React Team
  generateEmployee(60, 'Blake Moore', 'Senior React Developer', 'Engineering', 'San Francisco', 50, 11, 'WoodMac FTE'),
  ...
  generateEmployee(63, 'Nova Torres', 'Frontend Developer', 'Engineering', 'San Francisco', 50, 11, 'WoodMac FTE'),
  generateEmployee(64, 'River Martinez', 'Junior React Developer', 'Engineering', 'San Francisco', 50, 11, 'New Hire'),

  // UI/UX Engineering Team
  generateEmployee(65, 'Phoenix Garcia', 'UI Engineer', 'Engineering', 'Austin', 51, 11, 'WoodMac FTE'),
  generateEmployee(66, 'Sage Scott', 'UX Engineer', 'Engineering', 'Austin', 51, 11, 'WoodMac FTE'),
  ...
  generateEmployee(81, 'Casey Chen', 'Senior Backend Engineer', 'Engineering', 'Seattle', 70, 12, 'WoodMac FTE'),
  ...
  generateEmployee(84, 'Cameron Davis', 'Cloud Engineer', 'Engineering', 'Seattle', 70, 12, 'WoodMac FTE'),
  ...
  generateEmployee(87, 'Rowan Wang', 'Senior DBA', 'Engineering', 'Seattle', 71, 12, 'WoodMac FTE'),
  ...
  // API Services Team
  generateEmployee(90, 'Logan Martinez', 'API Team Lead', 'Engineering', 'Remote', 72, 12, 'WoodMac FTE'),
  generateEmployee(91, 'Zoe Anderson', 'API Developer', 'Engineering', 'Austin', 72, 12, 'Contractor'),
  generateEmployee(92, 'Caleb Wilson', 'Integration Engineer', 'Engineering', 'Remote', 72, 12, 'WoodMac FTE'),
  ...
  // iOS Team
  generateEmployee(110, 'Mason Taylor', 'iOS Team Lead', 'Engineering', 'Austin', 100, 13, 'WoodMac FTE'),
  generateEmployee(111, 'Lily Chen', 'Senior iOS Developer', 'Engineering', 'Austin', 100, 13, 'WoodMac FTE'),
  ...
  // Android Team
  generateEmployee(114, 'Hunter Davis', 'Android Team Lead', 'Engineering', 'Austin', 101, 13, 'WoodMac FTE'),
  generateEmployee(115, 'Nova Thompson', 'Senior Android Developer', 'Engineering', 'Austin', 101, 13, 'WoodMac FTE'),
  ...
  generateEmployee(133, 'Noah Garcia', 'Product Analyst', 'Product', 'Austin', 120, 3, 'WoodMac FTE'),
  ...
  generateEmployee(136, 'Charlotte Davis', 'Technical Product Manager', 'Product', 'Remote', 121, 3, 'WoodMac FTE'),
  ...
  generateEmployee(160, 'Evelyn Martinez', 'Senior Data Engineer', 'Data Science', 'Seattle', 150, 4, 'WoodMac FTE'),
  ...
  // Analytics Team
  generateEmployee(164, 'Avery Garcia', 'Senior Data Analyst', 'Data Science', 'Seattle', 151, 4, 'WoodMac FTE'),
  generateEmployee(165, 'Ella Davis', 'Business Intelligence Analyst', 'Data Science', 'Remote', 151, 4, 'WoodMac FTE'),
  ...
  generateEmployee(168, 'Jack Lee', 'ML Engineering Manager', 'Data Science', 'Boston', 152, 4, 'WoodMac FTE'),
  generateEmployee(169, 'Luna Rodriguez', 'Senior ML Engineer', 'Data Science', 'Boston', 152, 4, 'Architecture'),
  generateEmployee(170, 'Henry Kim', 'ML Engineer', 'Data Science', 'Remote', 152, 4, 'WoodMac FTE'),
  ...
  generateEmployee(191, 'Layla Wilson', 'Senior Cloud Engineer', 'Platform', 'Boston', 180, 5, 'WoodMac FTE'),
  generateEmployee(192, 'Aaron Taylor', 'Cloud Security Engineer', 'Platform', 'Remote', 180, 5, 'WoodMac FTE'),
  generateEmployee(193, 'Stella Brown', 'Infrastructure Engineer', 'Platform', 'Boston', 180, 5, 'New Hire'),

  // DevOps Team
  generateEmployee(194, 'Isaiah Garcia', 'DevOps Manager', 'Platform', 'Seattle', 181, 5, 'WoodMac FTE'),
  generateEmployee(195, 'Skylar Davis', 'Senior DevOps Engineer', 'Platform', 'Austin', 181, 5, 'WoodMac FTE'),
  ...
  generateEmployee(198, 'Roman Lee', 'SRE Manager', 'Platform', 'Boston', 182, 5, 'WoodMac FTE'),
  generateEmployee(199, 'Iris Rodriguez', 'Senior SRE', 'Platform', 'Remote', 182, 5, 'WoodMac FTE'),
  ...
  generateEmployee(240, 'Sage Patel', 'Full Stack Engineer', 'Engineering', 'San Francisco', 20, 11, 'WoodMac FTE'), // Works on Cloud Migration but reports to Sofia Martinez
  generateEmployee(241, 'Remy Rodriguez', 'Backend Engineer', 'Engineering', 'Seattle', 21, 12, 'WoodMac FTE'), // Works on Microservices Transformation but reports to David Park
  generateEmployee(242, 'Drew Thompson', 'Security Engineer', 'Security', 'Boston', 22, 5, 'WoodMac FTE'), // Works on DevSecOps Initiative but reports to Rachel Chen
];
